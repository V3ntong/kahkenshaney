...
///
/// Fields: Item Name, Category, Color, Date Lost, Location Lost, Photos.
/// Submits through [ItemRepository] and [StorageService] by default.
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Lost item report submitted.')),
      );
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              'Lost something? Give us the details below and we will help '
              'you track it down.',
